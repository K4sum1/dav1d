...
mkdir build-pgo-i686
meson setup --default-library=static --buildtype release -Db_pgo=generate build-pgo-i686
meson compile -C build-pgo-i686
...
meson configure -Db_pgo=use build-pgo-i686
meson compile -C build-pgo-i686
